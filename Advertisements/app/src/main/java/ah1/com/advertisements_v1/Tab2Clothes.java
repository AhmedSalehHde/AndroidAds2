...
public class Tab2Clothes extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.tab2clothes, container, false);
            ...
            protected void populateViewHolder(MainActivity.AdsViewHolder viewHolder, Ads model, int position) {
                ...
                viewHolder.aView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        Intent singleAdsIntent=new Intent(Tab2Clothes.this.getContext(),AdsSingleActivity.class);

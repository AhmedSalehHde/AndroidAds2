...
public class UserAdsActivity extends AppCompatActivity {
    ...
    private Query aQueryCurrentUser;
    ...
    aDatabaseCurrentUser= FirebaseDatabase.getInstance().getReference().child("Ads");
    aQueryCurrentUser=aDatabaseCurrentUser.orderByChild("uid").equalTo(currentUserId);
               ...
               // viewHolder.setCreationDate(model.getCreationDate());
                ...
                viewHolder.aView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        Intent singleAdsIntent=new Intent(UserAdsActivity.this,AdsSingleActivity.class);

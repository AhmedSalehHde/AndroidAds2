...
public class Tab3Restaurants extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.tab3restaurants, container, false);
        ...
        aQueryClothes=aDatabaseClothes.orderByChild("TypeAds").equalTo("مطاعم");
            ...
            protected void populateViewHolder(MainActivity.AdsViewHolder viewHolder, Ads model, int position) {
                ...
                viewHolder.aView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        Intent singleAdsIntent=new Intent(Tab3Restaurants.this.getContext(),AdsSingleActivity.class);
